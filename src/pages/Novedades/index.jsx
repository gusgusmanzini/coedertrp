  ...
  <section>
    <article>
      ...
      <div className="px-4 py-2 my-5 text-center d-lg-none d-xl-none">
        <img className="d-block mx-auto img-fluid mb-4 rounded" src={servicioscta1} alt="nuestrocheffatufiesta" />
      ...
      <div className="container col-xxl-8 px-4 py-2 d-none d-lg-block">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div className="col-10 col-sm-8 col-lg-6">
            <img src={servicioscta1} className="d-block mx-lg-auto img-fluid rounded" alt="llevamosnuestrosmeseros" width={700} height={500} loading="lazy" />
          </div>
